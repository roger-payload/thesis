...
\begin{document}
	...
	\chapter{Method}
		...
		\end{enumerate}
		Once this binary option conversion is done for all candidates, we sum up the hits of each option and get a single list for all accumulated hits, as seen in \hyperref[memory_insight]{figure 4.5}. Finally we can apply the mathematical formula to alter the probability vector, using the accumulated hits list, denoted as:\\
		\begin{math}
		...
		\paragraph{Extended funcion - progress}
