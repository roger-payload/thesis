...
\newcommand{\duo@page@i}{%
  \begin{titlepage}
    ...
    \ifthenelse{\equal{\duo@kind}{}}{}{%
      \duo@kind\par
      \vspace{1\baselineskip}}
    \ifthenelse{\equal{\duo@dept}{}}{}{%
      \duo@dept\par}
    \ifthenelse{\equal{\duo@fac}{}}{}{%
      \duo@fac\par
      \vspace{1\baselineskip}}
...
\newcommand{\duo@page@iii}{%
  \begin{titlepage}
    ...
    \centering
    \null\vfill
    {\fontsize{24}{28pt}\fontseries{b}\selectfont \@title\par}
    \vfill
    {\fontsize{20}{23pt}\fontshape{sl}\selectfont \duo@subtitle\par}
    \vfill
...
\newcommand{\duo@page@iv}{%
  \begin{titlepage}
    ...
    \vfill
    \raggedright
    \fontfamily{\duo@font}\selectfont
    \def \and {, }
...
\newcommand{\duo@fac@nn}{Det matematisk-naturvitenskapelege fakultet}
